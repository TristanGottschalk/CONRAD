...
public class SVDandFT {
	...
	public static void invertSVD(SimpleMatrix A)
	{
		...
		for(int i = 0; i < Sinv.getRows(); i++) { 
			...
			//double diagElement = svd.getS().getElement(i, i);
			//SinvDiag.setElementValue(i, 1.f/diagElement);
		}
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/os73isad/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/yu_fill.jpg";
